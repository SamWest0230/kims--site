        ...
        return (
            ...
            <section className='about'>
                <div className='about__desk'>
                    ...
                    <p className='about__info--textdesk'>I graduated from Centennial College in 2017. I am experienced in Swedish Massage with varying depths of pressure specific to each individual client. I strive to provide optimal treatments that will help decrease any pain, tension, or stress. <br /> <br />I  am capable of working with clients of all ages and provide many types of massage. Some modalities I offer include pregnancy massage, trigger point therapy, and deep tissue massage. Additionally, I provide clients with self care to do in between appointments. I believe my massages have a great flow that helps my clients relax as well as promote optimal health.</p> 
                    </div>

                    <div className='about__description'>
                    <img className='about__description--img' alt='Kim' src={kim} /> 
                    <p className='about__description--text'>I graduated from Centennial College in 2017. I am experienced in Swedish Massage with varying depths of pressure specific to each individual client. I strive to provide optimal treatments that will help decrease any pain, tension, or stress. <br /> <br />I  am capable of working with clients of all ages and provide many types of massage. Some modalities I offer include pregnancy massage, trigger point therapy, and deep tissue massage. Additionally, I provide clients with self care to do in between appointments. I believe my massages have a great flow that helps my clients relax as well as promote optimal health. </p>  
                    </div>
                </div>   
